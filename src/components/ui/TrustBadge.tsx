...
export const TrustBadge: React.FC<TrustBadgeProps> = ({ type = 'all', className = '' }) => {
  if (type === 'all') {
    return (
      <div className={`flex flex-wrap items-center justify-center gap-4 py-3 px-4 rounded-xl bg-bg-secondary/60 border border-border-subtle text-xs text-text-muted ${className}`}>
