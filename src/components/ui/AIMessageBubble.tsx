...
export const AIMessageBubble: React.FC<AIMessageBubbleProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`p-6 sm:p-8 rounded-2xl bg-bg-glass border border-cyan-500/20 backdrop-blur-xl shadow-xl shadow-cyan-950/10 relative overflow-hidden ${className}`}
    >
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="relative shrink-0">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-500 via-teal-500 to-indigo-600 p-0.5 shadow-lg shadow-cyan-500/25">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-center justify-between">
            <h4 className="text-sm font-semibold tracking-wide text-cyan-400 uppercase flex items-center gap-1.5">
              <span>{title}</span>
